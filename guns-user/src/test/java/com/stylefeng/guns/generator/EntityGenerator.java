...
public class EntityGenerator {
    ...
    public void entityGenerator() {
        ...
        gc.setOutputDir("D:\\Project\\project_guns\\guns-user\\src\\main\\java");//这里写你自己的java目录
        ...
        pc.setService("com.stylefeng.guns.user.modular.product.service");       //本项目没用，生成之后删掉
        pc.setServiceImpl("com.stylefeng.guns.user.modular.product.service.impl");   //本项目没用，生成之后删掉
        pc.setController("com.stylefeng.guns.user.modular.product.controller");    //本项目没用，生成之后删掉
